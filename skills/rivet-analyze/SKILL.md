...
# Rivet analyze — complexity score, then expand the over-scoped
...
- After editing the spec, run `rivet spec tasks` to sync, then `rivet spec draft-tests` for the new
  unbound criteria (hand to `rivet-test-author`).
