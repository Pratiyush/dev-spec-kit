...
# dev-spec-kit clarify — ≤5 questions, recommended-option, one at a time
...
- Record the resolved decisions in the intake doc (and, if the project wants it auditable, as a
  journaled note). Then hand to `dev-spec-kit-spec-author`. A clarification you didn't write down didn't
  happen.
